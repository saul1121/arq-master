...
public class DataManagerTest {
    ...
    public void syncRibotsEmitsValues() {
        ...
        mDataManager.syncRibots2().subscribe(result);
    ...
    public void syncRibotsCallsApiAndDatabase() {
        ...
        mDataManager.syncRibots2().subscribe();
        // Verify right calls to helper methods
        //verify(mMockRibotsService).getRibots2();
    ...
    public void syncRibotsDoesNotCallDatabaseWhenApiFails() {
        /*
        when(mMockRibotsService.getRibots2())
                .thenReturn(Observable.<List<Ribot>>error(new RuntimeException()));
*/
        mDataManager.syncRibots2().subscribe(new TestSubscriber<Ribot>());
        // Verify right calls to helper methods
  //      verify(mMockRibotsService).getRibots2();
